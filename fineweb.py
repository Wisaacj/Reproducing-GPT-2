...
# Create the cache in a local directory if it doesn't exist yet.
    ...
    for tokens in pool.imap(tokenize, fw, chunksize=16):
        ...
        if token_count + len(tokens) < shard_size:
            ...
            filename = os.path.join(
                DATA_CACHE_DIR, f"edufineweb_{split}_{shard_index:06d}.npy")
            # Split the documen4t into whatever fits in this shard; the remainder goes to the next one
